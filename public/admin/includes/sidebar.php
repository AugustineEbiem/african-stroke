<div class="sidebar-header bg-default">
	<div class="sidebar-toggle d-none d-md-flex bg-default" data-toggle-class="sidebar-left-collapsed" data-target="html" data-fire-event="sidebar-left-toggle">
		<i class="fas fa-bars" aria-label="Toggle sidebar"></i>
	</div>
</div>
<div class="nano bg-default">
	<div class="nano-content bg-default">
		<nav id="menu" class="nav-main" role="navigation">
			<ul class="nav nav-main">
				...
				<li class="nav-group-label text-light">Website Information</li>
				<li class="nav-parent">
					...
					<ul class="nav nav-children">
						...
						<li>
							<a class="nav-link" href="bec.php"> - Board And Executive
						</a>
						</li><li>
							<a class="nav-link" href="overview.php"> - Overview</a>
						</li>
						<li>
							<a class="nav-link" href="committees.php"> - Committees
						</a>
						</li><li>
							<a class="nav-link" href="taskforces.php"> - Taskforces</a>
						</li>
						<li>
						...
						<li>
							<a class="nav-link" href="bec.php"> - Vision
						</a>
						</li><li>
							<a class="nav-link" href="overview.php"> - Annual Report</a>
						</li>
						<li>
							<a class="nav-link" href="bec.php"> - President's Platform
						</a>
						</li><li>
							<a class="nav-link" href="overview.php"> - Secreteriat</a>
						</li>
						<li>
							<a class="nav-link" href="bec.php"> -Donation
						</a>
						</li><li>
							<a class="nav-link" href="bec.php"> -Partners
						</a>
						</li><li>
							<a class="nav-link" href="bec.php"> -Partnership/Funding
						</a>
						</li><li>
							<a class="nav-link" href="bec.php"> - Resources/Journal
						</a>
						</li><li>
							<a class="nav-link" href="bec.php"> -Podcasts
						</a>
						</li><li>
							<a class="nav-link" href="bec.php"> -News
						</a>
						</li><li>
							<a class="nav-link" href="bec.php"> -Blog
						</a>
						</li><li>
							<a class="nav-link" href="bec.php"> -Newsletters
						</a>
						</li>
					</ul>
				</li>
<!--<li class="nav-group-label">Membership</li>-->
<li class="nav-parent">
<a class="nav-link" href="#">
